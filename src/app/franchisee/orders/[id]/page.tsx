...
import { Item, itemColumns, LineItem, InvoiceInfo, getInvoiceStatus } from "@/types/entities"
...
export default function OrderPage() {
  ...
  useEffect(() => {
    if (invoice) {
      const items = invoice.invoice.Line
        .filter(line => 
            ...
            detailsContent={
              <OrderInfoSection
                ...
                actions={[{
                  ...
                  disabled: getInvoiceStatus(invoice.invoice.DocNumber).label !== "Draft"
                }]}
              />
            }
            itemsContent={
              <EditableOrderInfoSection
                ...
                onRemoveItem={(itemId) => {
                  setLineItems(prev => prev.filter(item => item.item.Id !== itemId))
                }}
